        ...
        body: Obx(() {
          return Stack(
            children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(0, 10, 0,
                            0),
                        child: Text(
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Obx(() {
                                                return Text(
                                                  'Total Booking Amount : Rs. ${qbController
                                                      .getPlan}/-',
                                                  style: FlutterFlowTheme
                                                      .of(context)
                                                      .displayMedium,
             ...
             if(qbController.getLoading) Container(

...
import 'package:client_manager/view_models/controller/booking/booking_form/payee.dart';
...
class Payee extends StatefulWidget {
  ...
  const Payee({Key? key, required this.onNextTab, required this.onBackTab}) : super(key: key);

  @override
  State<Payee> createState() => _PayeeState();
}

class _PayeeState extends State<Payee> {
  final pc = Get.put(PayeeController());
                            ...
                            children: [
                              Obx(() {
                                return Theme(
                                  ...
                                  child: Checkbox(
                                    value: pc.dmSameAsClient.value,
                                    onChanged:(newValue) async {
                                          pc.dmSameAsClient.value = newValue!;
                                          pc.dmSameAsClientAdd(newValue);
                                    },
                                    activeColor:
                                    FlutterFlowTheme
                                        .of(

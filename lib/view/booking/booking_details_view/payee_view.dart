      ...
      children: [
        Container(
          ...
          child: Obx(() {
            ...
            if (data?.payee != null) {
              var address = jsonDecode(data!.payee!.pAddr ?? "");
              return Column(
                mainAxisSize: MainAxisSize.max,
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                          bool result = await Get.toNamed(RouteName.payee);
                          if(result)
                          {
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: [
                                                                        TextSpan(
                                                                         ...
                                                                         TextSpan(
                                                                          text:
                                                                              '${address['p_state']}, ${address['p_pincode']}',
                                                                          style:
                                                                              const TextStyle(),
                                                                        )
                                                                      ],

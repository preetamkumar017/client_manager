...
class ClientAgreementView extends StatefulWidget {
  const ClientAgreementView({Key? key}) : super(key: key);

  @override
  _ClientAgreementViewState createState() => _ClientAgreementViewState();
}

class _ClientAgreementViewState extends State<ClientAgreementView> {
                ...
                child: DefaultTabController(
                  ...
                  child: Column(
                    children: [
                      TabBar(
                        isScrollable: true,
                        labelColor: FlutterFlowTheme.of(context).borderColor,
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * 0.666,
                                  height: 95.0,
                                  decoration: BoxDecoration(
                                    color:
